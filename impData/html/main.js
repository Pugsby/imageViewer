const clientVersion = "Beta v1: \"Numbnuts\" ~ vanilla";
...
function checkVersion() {
  fetch("api/checkUpdates")
    ...
    .then(data => {
      ...
      if (data.newVersion !== clientVersion) {
        updateNotice.style.display = "block";
        updateNotice.innerHTML = `Current Version: ${clientVersion} New Version: ${data.newVersion}<br>Get new update at <a href="https://github.com/Pugsby/imageViewer">the github repo.</a>`;
      }
    }
)}
checkVersion();
